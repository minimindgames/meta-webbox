...
//struct gbm_bo *bo2 = gbm_bo_create(gbm, 640, 480,  GBM_FORMAT_XRGB8888, GBM_BO_USE_RENDERING);
//printf("gbm_bo %p\n", bo2);
...
printf("gbm_surface_lock_front_buffer %p\n", gs);
   bo = gbm_surface_lock_front_buffer(gs);
//bo = bo2;
printf("gbm_surface_lock_front_buffer done\n");
